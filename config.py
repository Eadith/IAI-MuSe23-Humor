...
# BASE_PATH = os.path.join(Path(__file__).parent.parent, 'MuSe-2023', 'packages')    # 修改 BASE_PATH
BASE_PATH = "/data/yangyangxu/muse2023"     # 
...
# OUTPUT_PATH = os.path.join(BASE_PATH, 'results')    # 修改输出路径
OUTPUT_PATH = "/data/yangyangxu/muse2023-result"
